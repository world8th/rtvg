...
//pub trait Control {
//    fn new() -> Self;
//    fn render_loop(&self, w: &u32, h: &u32) -> u32;
//}
...
impl Renderer {
    ...
    // Create Pipeline
        ...
        let color_blend_state = vk::PipelineColorBlendStateCreateInfo::builder().logic_op(vk::LogicOp::CLEAR).attachments(&color_blend_attachment_states);
